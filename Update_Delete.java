...
public class Update_Delete {
	...
	public static void updateRecord() throws SQLException {
		...
		String updateTableQuery = "UPDATE jualan SET tabel_jualan = 'Minyak n' WHERE harga = '12.000'";
		...
		try {
			...
			System.out.println(recordCount + " record telah berhasil diupdate pada tabel jualan!");	
		}
